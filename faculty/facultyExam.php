...
ul.tab li a:focus, .active {
  ...
  <li><a class="active"  href="facultyExam.php">Exam Settings</a></li>
  <li style="float:right; border-left: 1px solid #bbb;"><a href="logout.php">LOG OUT</a></li>
	...
	<div class="wrapper">
		    ...
		    <h3 class="form-signin-heading">EXAM HALL SETTINGS</h3>
			  <hr class="colorgraph">
			  <form action="submng.php">
			  	<input type="submit" name="subManage" value="Add Subjects">
			  </form>
			  <form action="testmng.php">
			  	<input type="submit" name="testManage" value="Manage Test">
			  </form>
			  <form action="prepareQuestion.php">
			  	<input type="submit" name="questionManage" value="Prepare Question">
			  </form>
	</div>
</div>
<br><br><br><br><br>
