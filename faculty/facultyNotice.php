...
ul.tab li a:focus, .active {
  ...
  <li><a class="active" href="facultyNotice.php">Faculty Notice</a></li>
  ...
  <li style="float:right; border-left: 1px solid #bbb;"><a href="logout.php">LOG OUT</a></li>
	...
	<div class="wrapper">
		    ...
		    <h3 class="form-signin-heading">Faculty Notice</h3>
			  <hr class="colorgraph">
			  <b>ID CARD</b><br><br>
			Faculties are required to submit the request form for reissuing lost ID Cards along with a copy of the GD to local Police Station.<br>
