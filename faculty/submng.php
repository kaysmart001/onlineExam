...
#notice {
  ...
  <li style="float:right; border-left: 1px solid #bbb;"><a href="logout.php">LOG OUT</a></li>
	...
	<div class="wrapper">
		    ...
		    <h3 class="form-signin-heading">Manage Subjects</h3>
			  <hr class="colorgraph">
			  <form action="submng.php" method="post">
			  	
			  		
			  		<input type="text" class="form-control" name="course_id" placeholder="Course ID" required="" autofocus="" />
			  		<input type="text" class="form-control" name="course_name" placeholder="Course Name" required="" autofocus="" />
			  		<input type="text" class="form-control" name="course_desc" placeholder="Description" required="" autofocus="" />
			  		...
			  		$sqll = "insert into subject values('$course_id','$course_name','$course_desc',null)";
			  		mysql_query($sqll);
