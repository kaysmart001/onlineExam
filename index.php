	...
	<div class="wrapper">
		<form action="login.php" method="post" name="loginForm" class="form-signin">       
		    <font face="helvetica" size="5">Welcome! Please Log In</font>
			  ...
			  <input type="text" class="form-control" name="student_id" placeholder="Student ID" required="" autofocus="" /><br><br>
			...
			<div class="col-sm-4" id="createAccount">
				...
				<ul class="input-list style-1 clearfix">
						...
						<input type="text" name="major_signup" style='width:93%' placeholder="Enter Your Major">
            			<br><br>
            			<input type="text" name="minor_signup" style='width:93%' placeholder="Enter Your Minor">
            			<br><br>
