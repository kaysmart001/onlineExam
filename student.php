...
ul.tab li a:focus, .active {
  ...
  <li style="float:right; border-left: 1px solid #bbb;"><a href="logout.php">LOG OUT</a></li>
		...
		<font face="helvetica" size="5">Student Dashboard</font>
		<hr class="colorgraph">

		<form action="registrationStudent.php" method="post">
		<input type="submit" name="loadCourse" value="Registration">
		</form>
		...
		<input type="submit" value="Enrolled Course List">
		</form>
		...
		<form action="#">
		<input type="submit" value="Exam Query & Appearing">
		</form>
		</div>
